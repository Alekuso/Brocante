...
('Final Fantasy VII', 20.00, 'Final Fantasy VII pour PS1, version PAL, CD en bon état', 'ff7.jpg', 3, 2),
('SEGA Mega Drive', 40.00, 'SEGA Mega Drive modèle 1 avec câbles et une manette', 'megadrive.jpg', 1, 1),
('Sonic The Hedgehog 2', 8.00, 'Jeu Sonic 2 pour Mega Drive, cartouche seule', 'sonic2.jpg', 5, 2),
('Game Boy Color', 25.00, 'Game Boy Color violette translucide, quelques rayures', 'gbc.jpg', 6, 1),
('Pokémon Version Jaune', 18.00, 'Pokémon Jaune pour Game Boy, pile à changer', 'pokemonjaune.jpg', 3, 2),
('PlayStation 2', 30.00, 'PS2 Slim noire avec manette et memory card 8MB', 'ps2.jpg', 2, 1),
('Devil May Cry 3', 8.00, 'Devil May Cry 3 pour PS2, boîtier abîmé', 'dmc3.jpg', 7, 2),
...
('Manette NES', 8.00, 'Manette NES d''origine, boutons un peu durs', 'manetteNES.jpg', 5, 3),
('Game Genie NES', 15.00, 'Game Genie pour NES, sans livret', 'gamegenie.jpg', 1, 3),
('Macintosh Classic', 120.00, 'Apple Macintosh Classic de 1990, à réparer', 'macclassic.jpg', 10, 4),
...
('Mug Pac-Man', 3.00, 'Mug Pac-Man, légèrement ébréché', 'mugpacman.jpg', 12, 8),
('Nintendo 64', 45.00, 'Console N64 avec câbles, sans manette', 'n64.jpg', 1, 1),
('Mario Kart 64', 15.00, 'Jeu Mario Kart 64, cartouche seule', 'mariokart64.jpg', 12, 2),
('GameCube', 35.00, 'Nintendo GameCube noire avec câbles, sans manette', 'gamecube.jpg', 4, 1),
('Zelda Wind Waker', 20.00, 'The Legend of Zelda: Wind Waker, CD rayé mais fonctionnel', 'windwaker.jpg', 10, 2),
('Neo Geo Pocket', 45.00, 'Neo Geo Pocket Color bleue, écran à réparer', 'neogeopocket.jpg', 13, 1),
